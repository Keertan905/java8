...
class GenericAtMethod {
	// allow type B ,C and D
	public static void m1(List<? extends B> list) {
		// We can add only null value
		list.add(null);
		// below 3 are not allowed because of type safety violation
//		list.add(new B());
//		list.add(new C());
//		list.add(new D());
	}
...
//		list.add(q);
	...
	public static void m3(List<? super B> list) {
		...
		list.add(new D());
		list.add(new B());
		// not allowed because of type safety
//		list.add(new A());
//		list.add(new Object());
	}

	// allow type Y,X,Object
	...
	public static <T extends Number> void m5(T t) {

	}

//	public static < K super Number> void m6(K k) {
//
//	}
...
//  m2(l7) invalid
//  m2(l8); invalid
		// method m3() will accept only List of either B type or its
		// super-types(A,Object)
		m3(l1);
		m3(l2);
		m3(l9);
		// m3(l3); invalid
		// m3(l10); invalid
		// method m4() will accept only List of either Y type or its super
		// types(Y,Object)
		m4(l4);
		m4(l7);
		m4(l9);
